...
/datum/loadout_item/suit/navybluejacketofficer
	...
	restricted_roles = list(JOB_WARDEN, JOB_SECURITY_OFFICER)
...
/datum/loadout_item/suit/security_jacket
	...
	restricted_roles = list(JOB_WARDEN, JOB_SECURITY_OFFICER) //Not giving this one to COs because it's actually better than the one they spawn with
