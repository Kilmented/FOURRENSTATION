...
/obj/item/gun/ballistic/automatic/suppressed_rifle
	...
	load_sound = 'modular_warrenstation/lethalguns/sound/yari/yari_magin.wav'
	rack_sound = 'modular_warrenstation/lethalguns/sound/yari/yari_rack.wav'
	fire_sound = 'modular_warrenstation/lethalguns/sound/yari/yari.wav'
	suppressed_sound = 'modular_warrenstation/lethalguns/sound/yari/yari.wav'
	can_suppress = TRUE
	can_unsuppress = FALSE

	pickup_sound = 'modular_warrenstation/lethalguns/sound/pickup_sounds/drop_mediumgun.wav'
	drop_sound = 'modular_warrenstation/lethalguns/sound/pickup_sounds/drop_mediumgun.wav'
...
/obj/item/gun/ballistic/automatic/suppressed_rifle/marksman
	...
	load_sound = 'modular_warrenstation/lethalguns/sound/yari/yari_magin.wav'
	rack_sound = 'modular_warrenstation/lethalguns/sound/ransu/ransu_rack.wav'
	fire_sound = 'modular_warrenstation/lethalguns/sound/ransu/ransu.wav'
	suppressed_sound = 'modular_warrenstation/lethalguns/sound/ransu/ransu.wav'
	can_suppress = TRUE
	can_unsuppress = FALSE
