...
/obj/item/toy/groan_tube
	name = "groan tube"
	desc = "UUAAAA...   AAAUUUU"
	icon = 'modular_warrenstation/icons/obj/toy.dmi'
...
/obj/item/toy/groan_tube/attack_self(mob/user)
	if(COOLDOWN_FINISHED(src, groan_cooldown))
		...
		if(flipped)
			playsound(loc, 'modular_warrenstation/sound/items/aaau.ogg', 50, FALSE, 3)
			say("AAAUUU")
		else
			playsound(loc, 'modular_warrenstation/sound/items/uuua.ogg', 50, FALSE, 3)
			say("UUAAAA")
