// this is a port of Bubberstation's port.
...
/obj/structure/cargo_shelf //Crate shelf port from Shiptest: https://github.com/shiptest-ss13/Shiptest/pull/2374
	...
	icon = 'modular_warrenstation/icons/obj/structures.dmi'
...
/obj/structure/cargo_shelf/Initialize()
	...
	for(var/i in 1 to (capacity - 1))
		...
		overlays += image(icon = 'modular_warrenstation/icons/obj/structures.dmi', icon_state = "shelf_stack", layer = stack_layer, pixel_y = stack_offset)
	return
...
// this won't work for reasons my sleep deprived ass doesn't undestand

/*
/obj/structure/cargo_shelf/deconstruct(disassembled = FALSE)
