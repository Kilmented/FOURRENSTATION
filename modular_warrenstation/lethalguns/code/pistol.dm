...
/obj/item/gun/ballistic/automatic/pistol/weevil
	...
	icon = 'modular_warrenstation/lethalguns/icons/guns32x.dmi'
	icon_state = "zomushi"

	rack_sound = 'modular_warrenstation/lethalguns/sound/zomushi/zomushi_rack.wav'
	fire_sound = 'modular_warrenstation/lethalguns/sound/zomushi/zomushi.wav'
	suppressed_sound = 'modular_warrenstation/lethalguns/sound/zomushi/zomushi_silenced.wav'
