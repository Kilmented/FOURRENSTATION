...
/mob/living/basic/trooper/gakster/ranged/filtre
	...
	faction = list(ROLE_DEATHSQUAD)
	loot = list(/obj/effect/mob_spawn/corpse/human/filtremob, /obj/item/lethalcash/bundle/c10)
	mob_spawner = /obj/effect/mob_spawn/corpse/human/filtremob
	r_hand = /obj/item/lethalcash/bundle/c10
...
/mob/living/basic/trooper/gakster/ranged/fathomer
	...
	maxHealth = 450
	health = 450
	loot = list(/obj/effect/mob_spawn/corpse/human/fathomer, /obj/item/lethalcash/bundle/c10)
...
/mob/living/basic/trooper/gakster/ranged/chauchat
	...
	maxHealth = 600
	health = 600
	loot = list(/obj/effect/mob_spawn/corpse/human/chauchat, /obj/item/shield/ballistic, /obj/item/lethalcash/bundle/c10)
	mob_spawner = /obj/effect/mob_spawn/corpse/human/chauchat
	r_hand = /obj/item/shield/ballistic
	l_hand = /obj/item/lethalcash/bundle/c10
