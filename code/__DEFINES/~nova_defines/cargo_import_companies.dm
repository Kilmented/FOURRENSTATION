...
#define CARGO_COMPANY_NRI_SURPLUS (1<<1)
#define CARGO_COMPANY_DEFOREST (1<<2)
#define CARGO_COMPANY_DONK (1<<3)
#define CARGO_COMPANY_KAHRAMAN (1<<4)
#define CARGO_COMPANY_FRONTIER_EQUIPMENT (1<<5)
#define CARGO_COMPANY_SOL_DEFENSE (1<<6)
#define CARGO_COMPANY_MICROSTAR (1<<7)
#define CARGO_COMPANY_VITEZSTVI_AMMO (1<<8)
